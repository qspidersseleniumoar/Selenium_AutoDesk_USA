...
public class DeleteContactTest extends BaseClass {
    ...
    public void deleteContact() throws Throwable{
    	...
    	testlog.log(LogStatus.INFO, "LOGIN sucessfull");
    	
    	//testlog.log(LogStatus.FAIL, "delete contact");
    	//testlog.log(LogStatus.WARNING, "delete contact");
    	...
    	testlog.log(LogStatus.INFO, "delete searched contact");
    
    	DeleteContact dc = PageFactory.initElements(driver, DeleteContact.class);
    	dc.searchContact(firstName );
    	dc.selBtn();
    	dc.deleteContactok();
